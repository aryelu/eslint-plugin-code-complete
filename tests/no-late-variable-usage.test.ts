  ...
  invalid: [
      ...
      errors: [
        {
          ...
          data: { name: 'x', lines: '9', max: '5', declarationLine: '3', usageLine: '12' }
        }
      ]
    },
    ...
    // Multiple variables with late usage
    {
      ...
      errors: [
        {
          messageId: 'lateVariableUsage',
          data: { name: 'a', lines: '10', max: '5', declarationLine: '3', usageLine: '13' }
        },
        {
          messageId: 'lateVariableUsage',
          data: { name: 'b', lines: '10', max: '5', declarationLine: '4', usageLine: '14' }
        }
      ]
    },
    ...
    // Custom maxLines option
    {
      ...
      errors: [
        {
          messageId: 'lateVariableUsage',
          data: { name: 'x', lines: '5', max: '2', declarationLine: '3', usageLine: '8' }
        }
      ]
    }
  ]
